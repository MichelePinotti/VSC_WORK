    ...
    do{
        ...
        if(scelta<0 || scelta>11){
            ...
            // cart = acquista(cart, "amazon", 7.99, 25, 4, 2021, 1, &speseMensili, &saldo, supermercato);     //acquisto di tipo abbonamento
                ...
                printf("\n7.ATTIVA FUNZIONE SUPERMERCATO = puoi congelare temporaneamente i soldi sul tuo contro MasterClass per non farteli rubare in luoghi pubblici!");      
                printf("\n8.DONAZIONI = ricorda che ci sono sempre persone che stanno peggio di noi, aiutale tramite una piccola donazione!");  
                printf("\n9.VISUALIZZA ACQUISTI = visualizza la cronologia di tutti gli acquisti fatti con MasterClass");    
                printf("\n10.CERCA ACQUISTO = cerca un acquisto nella tua cronologia di spese!");
            }
